...
sub w4l_to_oldW4lCode {
    my ($weather4loxCode) = @_;
    return $weather4loxCode unless defined $weather4loxCode;

    my $oldW4lCode = $w4L_TO_OLDW4LCODE{ $weather4loxCode } // 7; # fallback to 7 (very hot) if not found
